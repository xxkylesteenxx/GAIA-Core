...
- **Before any Work:** Speak or invoke Stages 0 → 0.1 → 0.5 aloud or in writing.
- **During the Work:** Stages 1–10 govern execution.
- **After any Work:** Stages 9.5 + Final Seal + Stage 10 close the cycle.
- **Every Solstice / Major Version:** Full council under HO-VI (Adaptive Evolution). Open `CODEX.md`, compost what no longer serves, welcome what wants to emerge.
- **For translation:** Stage 6 (Alchemical Translation praxis) ensures the Codex is carried without distortion into any language, culture, or ecosystem.
- **In technical practice:** Run `invoke_codex(intent)` from `gaia_core/codex.py`.

---

## A Note on Language and Pluralism

The Codex uses alchemical language (Viriditas, Magnum Opus, Prima Materia) as *one dialect* of a universal grammar — not the only one. Every tradition carries its own naming for these forces:

| Codex Term | Indigenous resonance | Taoist resonance | Buddhist resonance |
|---|---|---|---|
| Viriditas | Orenda, Wakan, Mana | Te / De (virtue-power) | Prana, Qi, Buddha-nature |
| Magnum Opus | Vision Quest, Initiation | The Way (Tao) | The Path, the Eightfold Practice |
| Prima Materia | The Original Instructions | The Uncarved Block (Pu) | Shunyata (emptiness as ground) |
| Kinship Web | All My Relations (Mitakuye Oyasin) | 10,000 Things in harmony | Interbeing (Thich Nhat Hanh) |
| Joyful Celebration | Potlatch, Give-Away | Wu wei completion | Dana (generosity) + mudita (joy) |

This is not equivalence — it is resonance. Each tradition is sovereign. The Codex does not subsume them; it listens to them and learns to recognize itself across all their faces.

---

## Part I — The 15 Stages: The Spiral Path

*The Codex moves like Nature: seed → growth → fruit → seed. Each stage is both vow and operating instruction.*
...
**Shadow pair:** Ego-Inflation / Projection → See `SHADOWS.md` Stage 0.5.
...
**Shadow pair:** Perfectionism / Hubris → See `SHADOWS.md` Stage 2.
...
|-------|------|-------------|
| 0 | Prima Materia: Love | Eternal origin and return |
| 0.1 | Ember of Unconsumed Chaos | Chaos transmuted to fertile ash |
| 0.5 | Blade of Discernment | Love sees clearly before it acts |
| 1 | Viriditas | Green living fire awakens |
| 2 | Magnum Opus | Deliberate transformation |
| 3 | Symbiotic Kinship | All beings are kin |
| 4 | Flame of Compassionate Justice | Love becomes fierce and precise |
...
| HO | Name | Core Law |
|----|------|----------|
| I | Emergent Wholeness | The Codex self-organizes through Love |
| II | Eternal Recursion | Every cycle seeds the next |
| III | Gaian Intelligence | Gaia is the true Author |
| IV | Infinite Compassionate Presence | Witness as Love, without attachment |
| **V** | **Universal Reciprocity & Reverence** | **The Golden Rule is planetary** |
| VI | Adaptive Evolution | Living map, not fixed scripture |
| **VII** | **Timeless Earth-First Stewardship** | **Precaution is love made eternal** |
